                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table class="table table-dashed table-hover digi-dataTable task-table table-striped"
                            ...
                            <tbody>
                            @if(!empty($commits[0]) && isset($commits[0]))
                            ...
                            @if(!empty($locales))
                                @foreach($locales as $key => $lang)
                                    <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <label class="form-label">@lang('admin.name')
                                                    - {{$lang['code']}}</label>
                                                <input type="text" class="form-control" name="name[{{$lang['code']}}]">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label">@lang('admin.description')
                                                    - {{$lang['code']}}</label>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <textarea class="form-control"
                                                                  name="description[{{$lang['code']}}]">{{ !empty($value['description'][$lang['code']])? $value['description'][$lang['code']]: NULL }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
            ...
            <div class="modal fade" id="deleteMain{{$value['id']}}" tabindex="-1" aria-labelledby="deleteMain{{$value['id']}}Label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.commits.destroy',$value['id']) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
