...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('site/assets/images/logo_colorful.svg') }}">
                ...
                <div class="bottom">
                    ...
                    <form action="{{ route('admin.loginAccept') }}" method="POST">
                        ...
                        <div class="input-group mb-25">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="info@profit.az" value="{{ old('email') }}">
                        </div>
