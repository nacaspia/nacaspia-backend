                                        ...
                                        <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="title[{{$lang['code']}}]" value="{{ !empty($news['title'][$lang['code']])? $news['title'][$lang['code']]: NULL }}">
                                                </div>
                                                <div class="col-12">
                                                    <label class="form-label">@lang('admin.text') - {{$lang['code']}}</label>
                                                    <textarea class="form-control" type="text" name="text[{{$lang['code']}}]" >{{ !empty($news['text'][$lang['code']])? $news['text'][$lang['code']]: NULL }}</textarea>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="editor form-control"
                                                              ...
                                                              name="fulltext[{{$lang['code']}}]">{!! !empty($news['fulltext'][$lang['code']])? $news['fulltext'][$lang['code']]: NULL !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="category_id" id="input-category">
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}" @if($category->id ==  $news->category_id) selected @endif>{{ !empty(json_decode($category, true)['title'][$currentLang])? json_decode($category, true)['title'][$currentLang]: null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="1" @if($news['status'] ==1) selected @endif>@lang('admin.active')</option>
                                                <option value="0" @if($news['status'] ==0) selected @endif>@lang('admin.nonactive')</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="is_main">
                                                <option value="1" @if($news['is_main'] ==1) selected @endif>@lang('admin.show')</option>
                                                <option value="0" @if($news['is_main'] ==0) selected @endif>@lang('admin.nonshow')</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="form-label">@lang('admin.datetime')</label>
                                            <input type="text" class="form-control" name="datetime" value="{{ date('Y-m-d\TH:i', strtotime($news->datetime)) }}">
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-xxl-9 col-sm-8">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <img src="{{ asset('uploads/news/'.$news->image) }}" style="width: 288px;!important;">
                                                                </div>
                                                            </div>
