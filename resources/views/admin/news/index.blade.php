...
@section('admin.content')
    ...
    <div class="main-content">
        <div class="dashboard-breadcrumb mb-25">
            ...
            @can('news-create')
            <a class="btn btn-sm btn-primary" href="{{ route('admin.news.create') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                @can('news-edit')
                                                <a href="{{ route('admin.news.edit',$data['id']) }}" class="btn btn-sm btn-icon btn-primary" title="@lang('admin.edit')">
                                            ...
                                            <div class="card-body animation-card">
                                                <div class="text-center" data-aos="flip-left">
                                                    <img src="{{ asset('uploads/news/'.$data->image) }}" alt="{{ !empty($data['title']['az'])? $data['title']['az']: $data['title']['az'] }}" style="max-height: 327px;!important;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        {{ $news->appends(request()->except('page'))->links('components.admin.pagination',['posts' => $news]) }}
