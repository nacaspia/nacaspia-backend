...
use App\Repositories\ProjectsRepositoryImpl;
...
class ProjectController extends Controller
{
    ...
    public function __construct(ProjectsRepositoryImpl $projectRepository)
    {
    ...
    public function index()
    {
        ...
        $currentLang = $this->currentLang;
        return view('admin.projects.index',compact('projects','currentLang'));
    }
    ...
    public function create()
    {
        ...
        $currentLang = $this->currentLang;
        return view('admin.projects.create', compact('locales','categories','currentLang'));
    }
    ...
    {
        try {
            $data = ProjectsHelper::data($projectsRequest);
    ...
    public function edit($id)
    {
        ...
        $categories = Category::orderBy('id','DESC')->get();
        $currentLang = $this->currentLang;
        return view('admin.projects.edit', compact('locales','project','categories','currentLang'));
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(ProjectsRequest $projectsRequest, $id)
    {
        try {
            $project = Project::where('id',$id)->first();
            $data = ProjectsHelper::data($projectsRequest,$project);
            $projectUp = $this->projectRepository->update($id,$data);
            if ($projectUp) {
    ...
    public function deleteSliderImage(Request $request)
    {
        ...
        $data = Project::whereJsonContains('slider_image', $imageName)->first();
        ...
        // Fiziki faylı sil
        $imagePath = public_path('uploads/projects/slider_image/' . $imageName);
